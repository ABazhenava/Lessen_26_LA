package by.itacademy.lessen26.notepad.entity;

import by.itacademy.lessen26.notepad.util.GenerateId;
...
public class Note implements Serializable {
    ...
    public String toString() {
        return getClass().getSimpleName() + " [id=" + id + ", title=" + title + ", content=" + content + ", d=" + d + "]";
    }
}
